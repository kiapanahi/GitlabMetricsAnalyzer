...
namespace Toman.Management.KPIAnalysis.ApiService.Migrations
{
    ...
    [Migration("20250927185020_UpdateDeveloperMetricsAggregateForPRD")]
    partial class UpdateDeveloperMetricsAggregateForPRD
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Toman.Management.KPIAnalysis.ApiService.Features.GitLabMetrics.Models.Entities.DeveloperMetricsAggregate", b =>
                {
                    ...
                    b.Property<decimal?>("ApprovalBypassRatio")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("approval_bypass_ratio");

                    b.Property<string>("AuditMetadata")
                        .HasColumnType("jsonb")
                        .HasColumnName("audit_metadata");

                    b.Property<decimal?>("AvgPipelineDurationSec")
                        .HasPrecision(12, 2)
                        .HasColumnType("numeric(12,2)")
                        .HasColumnName("avg_pipeline_duration_sec");

                    b.Property<decimal?>("BranchTtlP50H")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("branch_ttl_p50h");

                    b.Property<decimal?>("BranchTtlP90H")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                    ...
                    b.Property<decimal?>("DefectEscapeRate")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("defect_escape_rate");

                    b.Property<int>("DeploymentFrequencyWk")
                        .HasColumnType("integer")
                        .HasColumnName("deployment_frequency_wk");
                    ...
                    b.Property<decimal?>("FlakyJobRate")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("flaky_job_rate");

                    b.Property<int>("ForcePushesProtected")
                        .HasColumnType("integer")
                        .HasColumnName("force_pushes_protected");

                    b.Property<decimal?>("IssueSlaBreachRate")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("issue_sla_breach_rate");

                    b.Property<decimal?>("MeanTimeToGreenSec")
                        .HasPrecision(12, 2)
                        .HasColumnType("numeric(12,2)")
                        .HasColumnName("mean_time_to_green_sec");

                    b.Property<decimal?>("MrCycleTimeP50H")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("mr_cycle_time_p50h");

                    b.Property<int>("MrThroughputWk")
                        .HasColumnType("integer")
                        .HasColumnName("mr_throughput_wk");

                    b.Property<string>("NullReasons")
                        .HasColumnType("jsonb")
                        .HasColumnName("null_reasons");
                    ...
                    b.Property<int>("ReleasesCadenceWk")
                        .HasColumnType("integer")
                        .HasColumnName("releases_cadence_wk");

                    b.Property<decimal?>("ReopenedIssueRate")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("reopened_issue_rate");
                    ...
                    b.Property<int>("RollbackIncidence")
                        .HasColumnType("integer")
                        .HasColumnName("rollback_incidence");
                    ...
                    b.Property<decimal?>("SignedCommitRatio")
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)")
                        .HasColumnName("signed_commit_ratio");

                    b.Property<decimal?>("TimeInReviewP50H")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("time_in_review_p50h");

                    b.Property<decimal?>("TimeToFirstReviewP50H")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("time_to_first_review_p50h");
                    ...
                    b.Property<decimal?>("WipAgeP50H")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("wip_age_p50h");

                    b.Property<decimal?>("WipAgeP90H")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("wip_age_p90h");

                    b.Property<int>("WipMrCount")
                        .HasColumnType("integer")
                        .HasColumnName("wip_mr_count");
                    ...
                    b.HasIndex("SchemaVersion")
                        .HasDatabaseName("idx_dev_metrics_agg_schema_version");

                    b.HasIndex("WindowStart", "WindowEnd")
                        .HasDatabaseName("idx_dev_metrics_agg_window");

                    b.HasIndex("DeveloperId", "WindowStart", "WindowDays")
                        .IsUnique()
                        .HasDatabaseName("idx_dev_metrics_agg_developer_window");
